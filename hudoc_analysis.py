...
def dl_hudoc(from_date, to_date, save_name, accepted_types = ["JUDGMENTS", "DECISIONS, ADVISORYOPINIONS"], accepted_langs = ["ENG"], respondents = [], include_observer = True, experimental_short = False, custom_query = "", base_set_name = ""):
    ...
    try:
        ...
        print(error)
        eel.setProgress(-1, "Unhandled error during download, please contact jfnicklaus@gmail.com")
...
def export_docx(set_name, kw_dict, include_undecided = False):
    ...
    try:
        ...
        print(error)
        eel.setProgress(-1, "Unhandled error during export, please contact jfnicklaus@gmail.com")
